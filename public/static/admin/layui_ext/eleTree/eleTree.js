                            ...
                            if(options.showCheckbox){
                                ...
                                return [
                                    '{{# if(d[i]["'+options.request.checked+'"]) { }}',
                                        '<input type="checkbox" name="eleTree-node[]" value="{{d[i]["'+options.request.key+'"]}}" lay-ignore eleTree-status="1" checked data-checked class="layui-hide eleTree-hideen',
                                    '{{# }else{ }}',
                                        '<input type="checkbox" name="eleTree-node[]" value="{{d[i]["'+options.request.key+'"]}}" lay-ignore eleTree-status='+status+' class="layui-hide eleTree-hideen',
                                    '{{# } }}',
