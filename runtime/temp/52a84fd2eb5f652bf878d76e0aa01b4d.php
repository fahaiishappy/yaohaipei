<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"G:\wamp64\www\hico\public/../application/admin\view\article\edit.html";i:1626853444;s:58:"G:\wamp64\www\hico\application\admin\view\common\head.html";i:1624346804;s:58:"G:\wamp64\www\hico\application\admin\view\common\foot.html";i:1624346639;}*/ ?>
<!DOCTYPE html>
<html>
			...
			<div class="layui-col-md12">
				<form class="layui-form">
					<div class="layui-card">
						...
						<div class="layui-card-body layui-row layui-col-space10">
							<div class="layui-col-md12">
								<input type="text" name="sort" value="0" autocomplete="off" class="layui-input" value="<?php echo $info['sort']; ?>">
							</div>
						</div>
						...
						<div class="layui-card-body layui-row layui-col-space10">
							<div class="layui-col-md12">
								<input type="text" name="source" value="" autocomplete="off" class="layui-input" value="<?php echo $info['source']; ?>">
							</div>
						</div>
