<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"G:\wamp64\www\hico\public/../application/admin\view\classify\edit.html";i:1626319449;s:58:"G:\wamp64\www\hico\application\admin\view\common\head.html";i:1624346804;s:58:"G:\wamp64\www\hico\application\admin\view\common\foot.html";i:1624346639;}*/ ?>
<!DOCTYPE html>
<html>
						...
						<?php if($label == 1): ?>
							...
							<div class="layui-card-body layui-row layui-col-space10">
								<div class="layui-col-md12 layui-form">
									<select name="pid" id="pid" lay-verify="" lay-filter="pid">
										<?php if(is_array($cate) || $cate instanceof \think\Collection || $cate instanceof \think\Paginator): $i = 0; $__LIST__ = $cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if($vo['pid'] == 0 && $vo['id'] == $info['pid']): ?>
							...
							<div class="layui-card-body layui-row layui-col-space10">
								<div class="layui-col-md12" style="display: flex;">
									<input type="text" name="background" autocomplete="off" class="layui-input" value="<?php echo $info['background']; ?>">
